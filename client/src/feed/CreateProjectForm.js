...
export default function CreateProjectForm({ setShowUpload, setIsSubmitting }) {
    ...
    if (fileData["textFile"].data.length > 0) {
      ...
      if (
        ...
        maps.push({
          ...
          replacements: Object.keys(fileData["rpFile"].data).map(key => ({original: key, normed: fileData["rpFile"].data[key]})),
          active: true,
        });
      } else {
        maps.push({
    ...
    >
      {({
        ...
        <Form noValidate onSubmit={handleSubmit}>
          <p
            style={{ fontSize: "18px", fontWeight: "bold", marginTop: "0.5em" }}
          >
            Project Details
          </p>
          <Form.Row>
          ...
          >
            ...
            <tbody
              style={{ textAlign: "center", height: "5vh", overflow: "auto" }}
            >
              <tr>
                <td>
                  <input
          ...
          <p style={{ fontSize: "10px", color: "grey", marginBottom: "0.5em" }}>
          ...
          <p style={{ fontSize: "14px", color: "grey", marginBottom: "1em" }}>
            Select preprocessing actions to be applied to raw text documents
          </p>
