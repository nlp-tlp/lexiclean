...
export default function TokenUnderline({
  ...
  const removeReplacementPopover = (
    <Popover id={`remove-popover`}>
      <div className={classes.popoverContainer}>
        ...
        <div className={classes.actionContainer}>
          <div className={classes.actionBtnActive} onClick={() => remove()}>
  ...
  const addSuggestionPopover = (
    <Popover
      id={`add-suggestion-popover`}
    ...
    >
      <div className={classes.popoverContainer}>
        ...
        <div className={classes.actionContainer}>
          <div className={classes.actionBtnActive} onClick={() => addOne(true)}>
            <p className={classes.actionText}>
              <MdBookmark />
              Accept
            </p>
          ...
          <div className={classes.actionBtnActive} onClick={() => ignore()}>
            <p className={classes.actionText}>
              <MdDelete />
              Ignore
            </p>
        ...
        >
          <div
            style={{
              cursor: "pointer",
              width: inputWidth,
              backgroundColor: bgColourMap["rp"],
              height: "6px",
              borderRadius: "2px",
              marginTop: "2px",
              marginBottom: "0.5em",
        ...
        >
          <div
            style={{
              cursor: "pointer",
              width: inputWidth,
              backgroundColor: bgColourMap["st"],
              height: "6px",
              borderRadius: "2px",
              marginTop: "2px",
              marginBottom: "0.5em",
            ...
            onClick={() =>
              setShowAddSuggestionPopover(!showAddSuggestionPopover)
            }
          />
        </OverlayTrigger>
      ) : null}
